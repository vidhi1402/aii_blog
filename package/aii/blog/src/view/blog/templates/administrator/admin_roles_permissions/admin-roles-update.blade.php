<form  method="post" role="form" action="{{ Route('blog.admin.admin_roles.update') }}" >
    {{csrf_field()}}
  ...
  <div class="col-md-6">
    ...
    <button type="submit" name="selected_role" class="btn btn-success" value="{{ $id->id }}">Update</button>
     </div>
  </div>
</form>
