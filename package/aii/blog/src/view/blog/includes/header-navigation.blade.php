...
<!--logo start-->
<a href="index.php" class="logo">Aii<span> Blog Panel</span></a>
<!--logo end-->
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">{{Auth::guard('blog_admin')->user()->name}}</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <div class="log-arrow-up"></div>
                <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                @if(Auth::guard('blog_admin')->user())
                    <li> <a href="javascript:void(0)"
                        ...
                        <form id="logout-form-admin" action="{{ route('blog.auth.logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
                    </li>
                @endif
